...
Assert.assertEquals("Both email should match", emailToUse, actualEmail);
    ...
    public void user_fills_out_the_form_with_valid_information_and_existing_email(io.cucumber.datatable.DataTable dataTable) {
    ...
    public void error_message_should_be_appear(String string) {
